...
export default function Navigation() {
  ...
  return (
    <Disclosure as="nav" className="sticky top-0 bg-white shadow-lg border-b-2 w-100">
      {({ open }: any) => (
        <React.Fragment>
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <Link href="/">
                  <a className="flex-shrink-0 flex items-center">
                    ...
                    />
                    <p className='
                        sm:block sm:font-normal
                        text-sm sm:text-base
                        font-normal sm:font-bold 
                        ml-1 mr-10 sm:ml-3
                        text-indigo-500 hover:text-amber-500 
                        animate-bounce
                        cursor-pointer
                      '
                    >
                    ...
                    {navigation?.map((item: any) => (
                      ...
                      >
                        <a className={classNames(
                            item?.href === path ? 'bg-amber-500 text-white' : 'text-gray-500 hover:bg-gray-400 hover:text-white',
              ...
              {navigation.map((item: any) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item?.href === path ? 'bg-amber-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white ',
